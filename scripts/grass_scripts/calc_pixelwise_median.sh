...
# set parameters
BAND=VV
GRID_SHP=/mnt/poseidon/remotesensing/arctic/data/vectors/supplementary/tundra_alaska_grid_latlon/tundra_alaska_grid.shp
...
GRIDCELLS=/mnt/poseidon/remotesensing/arctic/data/vectors/supplementary/tundra_alaska_grid_cells_latlon/GRIDCELL_*.shp
