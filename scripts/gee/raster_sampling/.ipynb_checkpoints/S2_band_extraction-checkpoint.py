...
# output file
DIR_PATH = '/mnt/poseidon/remotesensing/arctic/data/rasters/S2SR/training_test04_nonparent'
try:
...
# AKAVA test 04
di = '/mnt/poseidon/remotesensing/arctic/data/training/Test_04/original_files/'
fi = 'AKAVA_fcover_total_merged.csv'
obs_data = pd.read_csv(di + fi)
...
# NEON
di = '/mnt/poseidon/remotesensing/arctic/data/training/Test_04/original_files/'
fi = 'NEON_fcover_total_merged.csv'
obs_data = pd.read_csv(di + fi)
...
# Seward test 04
di = '/mnt/poseidon/remotesensing/arctic/data/training/Test_04/original_files/'
fi = 'NGEE_SP_fcover_total_merged.csv'
obs_data = pd.read_csv(di + fi)
